...
function displaySuccessMessage() {
    ...
    let successCode =
        '<h2 class="c-scroll__heading">Consgrats!!!</h2><p class="c-scroll__paragraph">Come let\'s decode the da Vinci Code</p> <br> <form action = "/desert" method = "POST"><input type="button" name="newID" placeholder="Button"><button>Proceed</button></form>';
